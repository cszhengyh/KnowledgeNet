...
non-euclidean_geometry_labels = ["Riemannian Geometry"]
stochastic_process_labels = ["Gaussian Process", "Stationary Process", "Point Process"]
sampling_theory_labels = ["Sampling Distribution", "Survey Sampling"]
bayesian_statistics_labels = ["Parameter Estimation"]
plasticity__physics__labels = ["Elastoplasticity"]
linear_acoustics_labels = ["Ray Acoustics", "Acoustics of Waves", "Atmospheric Acoustics", "Acoustic Reflection", "Scattering", "Diffraction", "Interferometry", "Attenuation (signal processing)"]
acoustoelasticity_labels = ["Aeroacoustics", "Fluid-Structure Interaction and Acoustics", "Fluid-Structure Interaction Acoustics", "Combustion Acoustics"]
acoustic_issues_in_information_science_labels = ["Communication Acoustics", "Acoustic MEMS", "Acoustic Channel"]
crystallography_labels = ["Crystal Growth", "Crystal Chemistry"]
organometallic_chemistry_labels = ["Organometallic Chemistry"]
...
celestial_mechanics_labels = ["Artificial Satellite", "Spacecraft Dynamics"]
high-energy_astrophysics_labels = ["Astronuclear Physics"]
atmospheric_physics_labels = ["Atmospheric Optics", "Atmospheric Acoustics", "Atmospheric Electricity", "Mesophysics"]
atmospheric_sensing_labels = ["Atmospheric Remote Sensing"]
dynamic_meteorology_labels = ["Numerical Weather Prediction and Numerical Simulation"]
physical_geography_labels = ["Ecogeography", "Glaciology", "Cryopedology", "Desert Studies", "Karstology"]
mineralogy_labels = ["Radiomineralogy"]
ore_deposits_and_mineralogy__excluding_petroleum_and_natural_gas_and_coal__labels = ["Radiogenic Ore Deposits"]
structural_geology_labels = ["Microstructure Science"]
...
reproductive_biology_of_animals_labels = ["Animal Reproduction Science", "Embryology"]
ethology_labels = ["Domestication"]
...
cataloging_labels = ["Bibliographic Organization", "Bibliographic Citation Method", "Computer Cataloging"]
bibliography_labels = ["General Bibliography", "List of Specialties", "History of Bibliography"]
library_science_labels = ["Reader Psychology", "Reader"]
