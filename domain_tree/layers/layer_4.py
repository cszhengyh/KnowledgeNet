...
prairie_science_labels = ["Forage Science", "Forage Breeding", "Forage Cultivation", "Grassland Ecology", "Grassland Conservation"]
...
standard_principles_and_methods_labels = ["Principle of Standardization", "Standard System", "Standard Consistency Testing", "Standard Statistical Methods", "Standardized Certification and Accreditation Methods", "Standard Rules and Procedures and Formats"]
standard_basis_theory_labels = ["History of Standardization Development", "Standardization Economics", "Terminology Standardization", "Standardization of Information Classification and Coding", "Graphical Symbol Standardization", "Research on Standard Materials", "Standard Document"]
benchmarking_engineering_and_applications_labels = ["Standardization Mechanisms and Systems Research", "Standard Management Studies", "Standardization of Quality Control and Evaluation", "Standardization of Human Ergonomics"]
...
ocean_resource_development_and_utilization_technology_labels = ["Marine Mineral Resources", "Seawater Resources", "Marine Biology", "Ocean Energy Exploitation Technology"]
ocean_observation_and_forecasting_technology_labels = ["Underwater Ocean Technology", "Ocean Observation Technology", "Ocean Remote Sensing Technology", "Ocean Forecasting and Prediction Technology"]
agricultural_machinery_science_labels = ["Agricultural Machinery Manufacturing"]
agricultural_water_conservancy_labels = ["Irrigation Engineering", "Drainage Engineering"]
...
robotics_technology_labels = ["Industrial Robotics", "Intelligent Robotics", "Service Robotics"]
steam_engineering_labels = ["Boiler", "Steam Engine", "Steam Turbine"]
internal_combustion_engine_engineering_labels = ["Gasoline Engine", "Diesel Engine", "Gas Fuel Engine"]
power_generation_engineering_labels = ["Hydropower Engineering", "Thermal Power Engineering", "Wind Power Engineering", "Magnetohydrodynamic Power Generation Engineering"]
electric_power_technology_technology_labels = ["Energy-saving Technology"]
...
condiment_processing_technology_labels = ["Salt Processing Technology"]
special_building_materials_labels = ["Acoustic Materials", "Waterproof Materials", "Fire Protection Materials", "Thermal Insulation Materials", "Seismic-Resistant Materials", "Corrosion-resistant Materials", "Renovation Materials"]
...
morden_world_literature_history_labels = ["History of Contemporary World Literature"]
...
ancient_chinese_contract_documents_labels = ["Dunhuangology", "Studies on Ming and Qing Dynasty Contract Documents", "Fish Scale Book Studies"]
history_of_russia_labels = ["History of the Soviet Union"]
international_trade_labels = ["International Marketing", "International Commodity Studies"]
employment_economics_labels = ["Labor Market Economics"]
urban_economics_and_management_labels = ["Urban Economics Theory"]
land_economics_labels = ["Land Economics", "Agricultural Resource Economics"]
commodity_science_labels = ["Commodity Packaging and Technology"]
monetary_history_labels = ["History of the International Monetary System"]
investment_theory_labels = ["Financial Investment"]
financial_markets_labels = ["Monetary Markets", "Capital Markets", "International Financial Markets"]
financial_history_and_banking_history_labels = ["History of Financial Law"]
financial_system_theory_labels = ["Comparative Financial Systems"]
history_of_insurance_labels = ["History of Insurance Thought"]
army_campaign_studies_labels = ["Artillery Campaign Studies", "Armored Campaign Studies"]
army_tactics_labels = ["Artillery Tactics", "Armored Warfare Tactics", "Engineering Tactics", "Signal Corps Tactics", "Chemical and Biological Defense Tactics"]
...
library_cataloging_labels = ["Bibliographic Organization", "Documentation Method", "Computer Cataloging"]
